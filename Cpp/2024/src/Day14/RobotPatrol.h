   ...
   public:
    ...
    void Solution2() {
        int minDxX = *std::ranges::min_element( std::views::iota( 0, WIDTH ),
                                                {},
                                                std::bind( std::mem_fn( &RobotPatrol::centerVariance ), *this, std::placeholders::_1, true, WIDTH ) );
        int minDyY = *std::ranges::min_element( std::views::iota( 0, HEIGHT ),
                                                {},
                                                std::bind( &RobotPatrol::centerVariance, this, std::placeholders::_1, false, HEIGHT ) );
