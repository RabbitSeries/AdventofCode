...
The multithreading aproach has crashes my OS for many times, the dynamic programming method is fruitful. However, what if the position of spawned stones matters in the result calculation?
